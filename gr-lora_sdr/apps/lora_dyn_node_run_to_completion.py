...
# Title: Lora Dyn Node Run To Completion
...
class lora_dyn_node_run_to_completion(gr.top_block):
    ...
    def __init__(self, bw_rx=250000, bw_tx=250000, hist_avg=5, noise_elem=20, rx_freq=915e6, sf=7, tx_freq=915e6, udp_rx_port=6790, udp_tx_port=6788):
        gr.top_block.__init__(self, "Lora Dyn Node Run To Completion")
...
def main(top_block_cls=lora_dyn_node_run_to_completion, options=None):
    if options is None:
