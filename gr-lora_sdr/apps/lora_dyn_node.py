...
class lora_dyn_node(gr.top_block):
    ...
    def __init__(self, hist_avg=5, noise_elem=20, rx_freq=915e6, sf=7, tx_freq=915e6, udp_rx_port=6790, udp_tx_port=6788):
        ...
        self.uhd_usrp_source_0.set_samp_rate(usrp_rx_samp_rate)
        ...
        self.lora_sdr_rx_tag_param_dyn_0 = lora_sdr.rx_tag_param_dyn()
        ...
        self.msg_connect((self.lora_sdr_general_supervisor_0, 'GS_rx_cmd'), (self.lora_sdr_rx_tag_param_dyn_0, 'RX_cmd'))
        ...
        self.connect((self.blocks_keep_m_in_n_0, 0), (self.hier_lora_rx_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.blocks_keep_m_in_n_0, 0))
        self.connect((self.lora_sdr_rx_tag_param_dyn_0, 0), (self.interp_fir_filter_xxx_0, 0))
        self.connect((self.uhd_usrp_source_0, 0), (self.lora_sdr_rx_tag_param_dyn_0, 0))
